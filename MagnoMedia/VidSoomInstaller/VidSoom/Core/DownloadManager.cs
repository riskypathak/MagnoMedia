...
namespace MyDownloader.Core
{
    public class DownloadManager
    {
        ...
        public Downloader Add(ResourceLocation rl, ResourceLocation[] mirrors, string localFile, string Title, List<Segment> segments, RemoteFileInfo remoteInfo, int requestedSegmentCount, bool autoStart, DateTime createdDateTime)
        {
            Downloader d = new Downloader(rl, mirrors, localFile, Title, segments, remoteInfo, requestedSegmentCount, createdDateTime);
            Add(d, autoStart);
